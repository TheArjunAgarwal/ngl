# 🥭 AAM — Actually Anonymous Messages

> Today I learnt that NGL (the stupid insta game where people ask their friends to anonymously ask them stupid questions or do stupid confessions) creates messages without permission or information.  
> Sure you can close this from settings but this is so stupid (and a bait to get you to buy their premium to see which friend confessed which is a breach of the friends' privacy as well). Like some of these were so eerily/weirdly/creepily things normal people could/would say... Just that I have a very specific group of friends and they wouldn't say those to me.

Yeah, that. **NGL is not safe with your data**.  
It's not even honest about where the "anonymous" messages come from.

Some are literally **AI-generated bait** to make you spend money or keep using the app.
...
- Switch to embedding Google Forms (though "privacy" and "Google" in the same sentence is a bit oxymoronic)
- Build your own backend server (requires learning more, but honestly? It's fun and you'll learn a ton)
...
Made by someone who was both **bored** and **tired of creepy "anonymous" apps that aren't actually anonymous**.

Fork it. Remix it. Break it. Learn from it. Make it your own.  
